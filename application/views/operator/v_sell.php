    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <?php if (!empty($this->session->userdata('sess_id'))) : ?>
                <a href="<?= site_url('operator/sell/cart/' . $this->session->userdata('sess_id')) ?>" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm text-white"><i class="fas fa-eye fa-sm text-white"></i> Live Transaction</a>
            <?php endif; ?>
            <a href="<?= site_url('operator/sell/create') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm text-white"><i class="fas fa-plus fa-sm text-white"></i> Add Sell Transaction</a>
        </div>
    </div>
    <!-- end Page Heading -->
                        ...
                        <tbody>
                            ...
                            foreach ($sells as $sell) :
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="<?= site_url('operator/sell/show/' . $sell->id_sell) ?>" class="btn btn-sm btn-success">
