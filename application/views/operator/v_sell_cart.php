...
<div class="container-fluid">
   ...
   <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800"><i class="fa fa-cart-plus"></i> Transaction Selling</h1>
      <h1 class="h3 mb-0 text-gray-800" id="grand_total"></h1>
   </div>
   <!-- end Page Heading -->

   <form action="<?= site_url('operator/sell/update/' . $this->session->userdata('sess_id')) ?>" method="post" enctype="multipart/form-data">
      <!-- content -->
      <div class="row">
         <div class="col-12">
                  ...
                  <div class="row">
                     ...
                     <div class="col-6">
                        <div class="form-group">
                           ...
                           <a href="<?= site_url('operator/sell/delete/' . $this->session->userdata('sess_id')) ?>" class="btn btn-danger">
